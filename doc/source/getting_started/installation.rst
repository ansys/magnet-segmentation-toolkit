...
.. list-table:: Available Installers
   ...
   * - `Download <https://github.com/ansys/magnet-segmentation-toolkit/releases/latest/download/Magnet-Segmentation-Toolkit-Installer-windows.exe>`_
     - Windows
   * - `Download <https://github.com/ansys/magnet-segmentation-toolkit/releases/latest/download/Magnet-Segmentation-Toolkit-Installer-ubuntu_22_04.zip>`_
     - Ubuntu 22.04
   * - `Download <https://github.com/ansys/magnet-segmentation-toolkit/releases/latest/download/Magnet-Segmentation-Toolkit-Installer-ubuntu_24_04.zip>`_
     - Ubuntu 24.04
