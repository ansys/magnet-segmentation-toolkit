...
OUT_PATH = 'magnet_segmentation_toolkit'
APP_NAME = 'magnet_segmentation_toolkit' if is_linux else 'Magnet Segmentation Toolkit'

CODE_PATH = os.path.join(THIS_PATH, 'src/ansys/aedt/toolkits/magnet_segmentation')
...
added_files = [
    (os.path.join(ASSETS_PATH, 'magnet_segmentation.png'), 'assets'),
...
a = Analysis([main_py],
             ...
             binaries=[],
             datas=added_files,
             hiddenimports=['ansys.aedt.toolkits.magnet_segmentation.backend.run_backend', 'ansys.aedt.toolkits.magnet_segmentation.ui.run_frontend'],
