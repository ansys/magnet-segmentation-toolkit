...
################################################################################
## Form generated from reading UI file 'segmentation_column.ui'
##
...
class Ui_LeftColumn(object):
    def setupUi(self, LeftColumn):
        ...
        self.menu_segmentation = QWidget()
        self.menu_segmentation.setObjectName(u"menu_segmentation")
        self.menu_home_layout = QVBoxLayout(self.menu_segmentation)
        ...
        self.segmentation_vertical_layout = QVBoxLayout()
        self.segmentation_vertical_layout.setObjectName(u"segmentation_vertical_layout")

        self.menu_home_layout.addLayout(self.segmentation_vertical_layout)

        self.verticalSpacer = QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)

        self.menu_home_layout.addItem(self.verticalSpacer)

        self.menus.addWidget(self.menu_segmentation)
