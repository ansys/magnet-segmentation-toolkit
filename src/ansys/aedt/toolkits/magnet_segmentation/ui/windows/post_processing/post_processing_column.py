...
class Ui_LeftColumn(object):
    def setupUi(self, LeftColumn):
        ...
        self.menu_postprocessing = QWidget()
        self.menu_postprocessing.setObjectName(u"menu_postprocessing")
        self.menu_home_layout = QVBoxLayout(self.menu_postprocessing)
        ...
        self.postprocessing_vertical_layout = QVBoxLayout()
        self.postprocessing_vertical_layout.setObjectName(u"postprocessing_vertical_layout")

        self.menu_home_layout.addLayout(self.postprocessing_vertical_layout)

        self.verticalSpacer = QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)

        self.menu_home_layout.addItem(self.verticalSpacer)

        self.menus.addWidget(self.menu_postprocessing)
