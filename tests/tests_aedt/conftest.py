...
class BasisTest(object):
    ...
    def add_app(
        ...
        if project_name:
            example_project = os.path.join(Path(local_path).parent, "input_data", project_name + ".aedt")
            example_folder = os.path.join(Path(local_path).parent, "input_data", project_name + ".aedb")
