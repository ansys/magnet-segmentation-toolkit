; NSIS script for Magnet Segmentation Toolkit installer

; Set the name, version, and output path of the installer
!define LICENSE_FILE "LICENSE"
!define PRODUCT_NAME "Magnet Segmentation Toolkit"
!define /file PRODUCT_VERSION "installer\VERSION"
!define OUTFILE_NAME "Magnet-Segmentation-Toolkit-v${PRODUCT_VERSION}.exe"
...
Function CreateDesktopShortCut
  CreateShortCut "$desktop\${PRODUCT_NAME}.lnk" "$INSTDIR\Magnet Segmentation Toolkit.exe"
FunctionEnd

!define MUI_FINISHPAGE_RUN "$INSTDIR\Magnet Segmentation Toolkit.exe"
...
Section "${PRODUCT_NAME}" SEC01
  ...
  ; Copy the files from the dist\magnet_segmentation_toolkit directory
  ; File /r /oname=ignore "dist\magnet_segmentation_toolkit\*"
  File /r "dist\magnet_segmentation_toolkit\*"
...
Icon "dist\magnet_segmentation_toolkit\_internal\assets\splash_icon.ico"
